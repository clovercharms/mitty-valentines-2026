...
@export var doHitVibrate: bool = false
@export var hitVibratePower: float = 0.3
@export var hitVibrateTime: float = 0.2
...
func playHitEffects():
	...
	if doHitVibrate: Input.start_joy_vibration(0, 0, hitVibratePower, hitVibrateTime)
